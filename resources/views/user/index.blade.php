		...
		<div class="col-md-12">
			<div class="panel panel-primary">
			  <div class="panel-heading">Data Member
			  	<div class="panel-title pull-right"><a href="{{ route('user.create') }}"><i class="fa fa-user-plus"></i></a>
			  	</div>
			  </div>
			  <div class="panel-body">
				  ...
				  <table class="table">
				  	...
				  	<tbody>
						...
						<td>
							<a class="btn btn-outline-warning" href="{{ route('user.edit',$data->id) }}"><i class="fa fa-edit"></i></a>
						</td>
						<td>
